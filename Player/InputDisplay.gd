...
var arrow_scenes = {
	"up" : preload("res://Qte_arrows/up_arrow.tscn"),
	"down" : preload("res://Qte_arrows/down_arrow.tscn"),
	"left" : preload("res://Qte_arrows/left_arrow.tscn"),
	"right" : preload("res://Qte_arrows/right_arrow.tscn") 
}
